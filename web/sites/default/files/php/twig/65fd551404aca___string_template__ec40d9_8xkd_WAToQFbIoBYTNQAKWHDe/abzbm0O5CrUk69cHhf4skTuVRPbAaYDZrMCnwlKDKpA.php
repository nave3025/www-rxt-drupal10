...
class __TwigTemplate_8f2613ef23897a397403fb83732923f1 extends Template
{
    private $source;
    private $macros = [];
...
<span class=\"media-info--";
        // line 2
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["bundle"] ?? null), 2, $this->source), "html", null, true);
        echo "\">";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["bundle"] ?? null), 2, $this->source), "html", null, true);
        echo "</span>
";
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["bundle", "name"]);    }
